...
[![codecov](https://codecov.io/gh/dungvmo/test-fastapi/branch/main/graph/badge.svg?token=test-fastapi_token_here)](https://codecov.io/gh/dungvmo/test-fastapi)
[![CI](https://github.com/dungvmo/test-fastapi/actions/workflows/main.yml/badge.svg)](https://github.com/dungvmo/test-fastapi/actions/workflows/main.yml)

Awesome test_fastapi created by dungvmo

## Install

from source
```bash
git clone https://github.com/dungvmo/test-fastapi test_fastapi
cd test_fastapi
make install
```
